...
return array(
	...
	'inserter' => false,
	'content'  => '<!-- wp:group {"tagName":"main","style":{"spacing":{"padding":{"top":"4rem","bottom":"6rem"}}},"layout":{"inherit":true}} -->
	<main class="wp-block-group" style="padding-top:4rem;padding-bottom:6rem"><!-- wp:heading {"textAlign":"center","align":"wide"} -->
