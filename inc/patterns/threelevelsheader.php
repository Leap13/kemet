 ...
 */
return array(
	'title'      => __( 'Three Levels Header', 'kemet' ),
...
<div class="wp-block-group has-background-background-color has-background" style="padding-top:2.5rem;padding-bottom:2.5rem"><!-- wp:group {"layout":{"type":"flex","allowOrientation":false,"justifyContent":"center"}} -->
...
<!-- wp:group {"style":{"border":{"radius":"0px"},"spacing":{"blockGap":"0px"}}} -->
<div class="wp-block-group" style="border-radius:0px"><!-- wp:group {"style":{"spacing":{"blockGap":"0px","padding":{"right":"0px","left":"0px"}},"color":{"background":"#2b2b2b05"}},"layout":{"inherit":true}} -->
...
<!-- wp:group {"layout":{"type":"flex","allowOrientation":false,"justifyContent":"right"}} -->
<div class="wp-block-group"><!-- wp:search {"label":"","buttonText":"Search","buttonPosition":"button-inside","buttonUseIcon":true} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<!-- wp:group -->
<div class="wp-block-group"><!-- wp:separator {"color":"cyan-bluish-gray","className":"is-style-wide eplus-wrapper"} -->
<hr class="wp-block-separator has-text-color has-background has-cyan-bluish-gray-background-color has-cyan-bluish-gray-color is-style-wide eplus-wrapper"/>
<!-- /wp:separator --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->',
