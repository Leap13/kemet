...
return array(
    ...
    <!-- wp:paragraph {"align":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"400"}}} -->
    <p class="has-text-align-center" style="font-style:normal;font-weight:400">' . esc_html__( 'Lorem natusnatus beatae vitae sunt unde.', 'kemet' ) . '</p>
    <!-- /wp:paragraph --></div>
    <!-- /wp:group -->
    ...
    <!-- wp:paragraph {"align":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"400"}}} -->
    <p class="has-text-align-center" style="font-style:normal;font-weight:400">' . esc_html__( 'Quasi architecto natus beatae vitae sunt.', 'kemet' ) . '</p>
    <!-- /wp:paragraph --></div>
    <!-- /wp:group -->
