...
return array(
    ...
    <p style="font-style:normal;font-weight:400">' . esc_html__( 'Give your property a professional touch and organic atmosphere with our authentic gardening services.', 'kemet' ) . '</p>
    <!-- /wp:paragraph -->
    ...
    <div class="wp-block-button has-custom-font-size is-style-fill has-normal-font-size"><a class="wp-block-button__link has-background-color has-tertiary-background-color has-text-color has-background" href="#"><strong>Let\'s Get Started</strong></a></div>
    <!-- /wp:button --></div>
    <!-- /wp:buttons --></div>
    <!-- /wp:column -->
    ...
    <h4 class="has-text-align-center" style="font-style:normal;font-weight:700;margin-top:10px;margin-bottom:0px">' . esc_html__( 'Hedging Services', 'kemet' ) . '</h4>
    <!-- /wp:heading -->
    
    <!-- wp:paragraph {"align":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"400"}}} -->
    <p class="has-text-align-center" style="font-style:normal;font-weight:400">' . esc_html__( 'Sed ut perspiciatis unde omnis iste natus ipsum.', 'kemet' ) . '</p>
    <!-- /wp:paragraph --></div>
    <!-- /wp:group -->
    ...
    <!-- wp:heading {"textAlign":"center","level":4,"style":{"spacing":{"margin":{"top":"10px","bottom":"0px"}},"typography":{"fontStyle":"normal","fontWeight":"700"}}} -->
    <h4 class="has-text-align-center" style="font-style:normal;font-weight:700;margin-top:10px;margin-bottom:0px">' . esc_html__( 'Irrigation Services', 'kemet' ) . '</h4>
    <!-- /wp:heading -->
    
    <!-- wp:paragraph {"align":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"400"}}} -->
    <p class="has-text-align-center" style="font-style:normal;font-weight:400">' . esc_html__( 'Accusantium doloremque laudantium totam rem.', 'kemet' ) . '</p>
    <!-- /wp:paragraph --></div>
    <!-- /wp:group -->
    ...
    <!-- wp:heading {"textAlign":"center","level":4,"style":{"spacing":{"margin":{"top":"10px","bottom":"0px"}},"typography":{"fontStyle":"normal","fontWeight":"700"}}} -->
    <h4 class="has-text-align-center" style="font-style:normal;font-weight:700;margin-top:10px;margin-bottom:0px">' . esc_html__( 'Mulching Services', 'kemet' ) . '</h4>
    <!-- /wp:heading -->
    
    <!-- wp:paragraph {"align":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"400"}}} -->
    <p class="has-text-align-center" style="font-style:normal;font-weight:400">' . esc_html__( 'Quasi architecto beatae vitae dicta sunt explicabo.', 'kemet' ) . '</p>
    <!-- /wp:paragraph --></div>
    <!-- /wp:group -->
