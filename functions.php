...
if ( ! function_exists( 'kemet_support' ) ) :
	function kemet_support()  {
		...
		// Language support
		load_theme_textdomain( 'kemet', get_template_directory() . '/languages' );
...
if ( ! function_exists( 'kemet_scripts' ) ) :
	function kemet_scripts() {
		...
		wp_enqueue_style( 'kemet-style', get_template_directory_uri() . '/style.css', $dependencies, wp_get_theme( 'Kemet' )->get( 'Version' ) );
	}
